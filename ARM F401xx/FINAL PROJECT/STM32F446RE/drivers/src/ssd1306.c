...
static void SSD1306_WriteCommand(I2C_Handle_t *hi2c, uint8_t cmd) {
    ...
    I2C_MasterSendData(hi2c, buf, 2, SSD1306_I2C_ADDR, I2C_DISABLE_SR);
}
...
void SSD1306_Init(I2C_Handle_t *hi2c) {
    ...
    SSD1306_WriteCommand(hi2c, 0x8D); // Enable
...
void SSD1306_SetCursor(I2C_Handle_t *hi2c, uint8_t column, uint8_t page) {
    ...
    SSD1306_WriteCommand(hi2c, 0x00 | (column & 0x0F));
    SSD1306_WriteCommand(hi2c, 0x10 | ((column >> 4) & 0x0F));
}
