...
/*************************************************************************
 * @fn                - usart2_GPIO_PinSetUp
 *
 * @brief             - This function configures the GPIO pins for USART2 (PA2 = TX, PA3 = RX)
 *
 * @param[in]         - none
 *
 * @return            - none
 *
 * @Note              - Uses Alternate Function 7 (AF7)
 */
