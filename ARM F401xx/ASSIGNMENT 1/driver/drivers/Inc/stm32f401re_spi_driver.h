...
typedef struct
{
	SPI_RegDef_t *pSPIx;              /* SELECT SPI1/SP12/SP3/SPI4 */\
...
void SPI_Transmit_Buffer(SPI_RegDef_t *pSPIx, uint8_t *pTxBuffer, uint8_t Tx_len);
void SPI_Recieve_Buffer(SPI_RegDef_t *pSPIx, uint8_t *pRxBuffer, uint8_t Rx_len);

void SPI_PeripheralControl(SPI_RegDef_t *pSPIx, uint8_t EnorDi);
uint8_t SPI_Get_FlagStatus(SPI_RegDef_t *pSPIx, uint8_t Flag);
